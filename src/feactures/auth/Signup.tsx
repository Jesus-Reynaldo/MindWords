...
export default function SignUp() {
  ...
  async function onSubmit(values: FormData) {
    ...
    if (!res.ok) return setServerError(data.error ?? 'Signup failed')
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow p-6">
        ...
        <p className="text-sm text-gray-500 mt-1">Save your words and track your reviews.</p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="mt-6 space-y-4">
          ...
          {pwd && <p className="text-xs text-gray-500">Tip: use at least 8 chars with numbers/letters.</p>}
